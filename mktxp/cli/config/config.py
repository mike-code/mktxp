...
class MKTXPConfigKeys:
    ...
    FE_WIREGUARD_KEY = 'wireguard'
    FE_WIREGUARD_PEERS_KEY = 'wireguard_peers'
    ...
    BOOLEAN_KEYS_YES = {PLAINTEXT_LOGIN_KEY, FE_DHCP_KEY, FE_PACKAGE_KEY, FE_DHCP_LEASE_KEY, FE_IP_CONNECTIONS_KEY, FE_INTERFACE_KEY, 
                        ...
                        FE_NETWATCH_KEY, FE_PUBLIC_IP_KEY, FE_USER_KEY, FE_QUEUE_KEY, FE_WIREGUARD_KEY, FE_WIREGUARD_PEERS_KEY}
