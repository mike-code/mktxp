    ...
    def collect(router_entry):
        ...
        if wg_interface_records:
            if router_entry.config_entry.wireguard_peers:
                wg_peer_info_labels = ['id', 'name', 'interface', 'public_key', 'endpoint_address', 'endpoint_port', 'current_endpoint_address', 'current_endpoint_port', 'allowed_address', 'comment', 'disabled']
